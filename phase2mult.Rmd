...
result.s2.sf.IUT <- data.frame(p0.s,p0.t, s1.rej=s1, t1.rej=t1, t1.acc=t2, s2.rej=a1, t2.rej=a2, N1=n1, N2=n2, Error=sig.s2.sf.IUT, Power=power.s2.sf.IUT)
...
```{r tidy=TRUE}
# set the intervals as +-1
UIT.design(method="s1",s2.rej=18, t2.rej = 12, n=80, s.delta =1, t.delta = 1, n.delta=1, p0.s = 0.15, p0.t = 0.25, p1.s = 0.3, p1.t= 0.1)
# defaut do not set the intervals
UIT.design(method="s1",s2.rej=18, t2.rej = 12, n=80, p0.s = 0.15, p0.t = 0.25, p1.s = 0.3, p1.t= 0.1, output.all = T)
# output all valid outcome
UIT.design(method="s1",s2.rej=18, t2.rej = 12, n=80, s.delta = 1, t.delta = 1, n.delta=1, p0.s = 0.15, p0.t = 0.25, p1.s = 0.3, p1.t= 0.1, output.all = T)
```
...
result.s2.sf.UIT <- data.frame(p0.s,p0.t,s1.rej=s1,t1.rej=t1, s2.acc=s2,t2.acc=t2, N1=n1, N2=n2, Error=sig.s2.sf.UIT, Power=power.s2.sf.UIT)
...
```{r tidy=TRUE}
UIT.design(method="s2.sf",s1.rej = 10, t1.rej = 3, s1.acc=8, t1.acc = 5, s2.rej=18, t2.rej = 12, n1=41, n2=41, s.delta =1, p0.s = 0.15, p0.t = 0.25, p1.s = 0.3, p1.t= 0.1, output.all=TRUE)
```
...
```{r tidy=TRUE}
UIT.design(method = "s2.f", s1.acc=7, t1.acc = 5, s2.rej=17, t2.rej = 13, n1=41, n2=41, s.delta =1, p0.s = 0.15, p0.t = 0.25, p1.s = 0.3, p1.t= 0.1, output.all=TRUE)
```
