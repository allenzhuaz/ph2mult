---
title: "Phase II single- or two-stage Multinomial Trial Design"
author: "Yalin Zhu"
date: "`r Sys.Date()`"
...
* IUT naturally arises in studied when a
significant outcome with respect to two or more objectives is
required in order to declare the study successful.

* No multiplicity adjustment is necessary to control the size of a
test but the individual hypotheses cannot be tested at levels
higher than the nominal significance level either.
...
### Find the rejection boundary for pCR and ePD based on pre-specified type I error rate and power level, and record the computing process time.
```{r echo=FALSE}
