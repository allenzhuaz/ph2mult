#' Derive a power function for multinomial design using IUT test
#'
#' Takes in degin method, stopping boundary thresholds and sample size, then return power function
#'
#' @param method A charater value of design methods, can be abbreviated as "s1", "s2.sf", "s2.f".
#' @param s1.rej A numeric value of rejection threshold in the first stage if using the two-stage designs.
#' @param s1.acc A numeric value of acceptance threshold in the first stage if using the two-stage designs.
#' @author Yain Zhu
#' @return A numeric vector of the exact power or type I error.
#' @export
